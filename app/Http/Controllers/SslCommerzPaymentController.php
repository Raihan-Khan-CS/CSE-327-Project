...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $post_data['payment_type'] = 'SSL';
        $post_data['invoice_no'] = 'MR'.mt_rand(10000000,99999999);
        ...
        $update_product = DB::table('orders')
            ...
            // ai khane invoice and email  value_a and value_b maddome pathano hoyse
            $invoice = Order::findOrFail($order_id);
            # OPTIONAL PARAMETERS
               $post_data['value_a'] = $invoice->invoice_no;
               $post_data['value_b'] = $request->email;
               $post_data['value_c'] = $request->name;
    ...
    public function payViaAjax(Request $request)
    {
        ...
        $update_product = DB::table('orders')
            ...
            # OPTIONAL PARAMETERS
               ...
               $post_data['value_c'] = $requestData['cus_name'];
               $post_data['value_d'] = "ref004";
