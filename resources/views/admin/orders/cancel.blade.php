...
<div class="iq-top-navbar">
    <div class="iq-navbar-custom">
       ...
       <div class="navbar-breadcrumb">
          <h5 class="mb-0">CANCEL ORDERS</h5>
          <nav aria-label="breadcrumb">
             <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('cancel.orders') }}">home</a></li>
                       ...
                       <thead>
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>
                                <span class="badge" style="background: #837f7e; color:white;font-size:14px;">
                                    {{ ucwords($item->status) }}</span><br>
                            </td>
                              <td>
