    ...
    <div class="iq-navbar-custom">
       ...
       <div class="navbar-breadcrumb">
          ...
          <nav aria-label="breadcrumb">
             <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('shipped.orders') }}">home</a></li>
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="flex align-items-center list-user-action">
                                    ...
                                    <a data-toggle="tooltip" data-placement="top" title="DOWNLOAD" data-original-title="Edit" href="{{ url('admin/invoice/download/'.$item->id) }}"><i class="fa fa-download"></i></a>
                                 </div>
                              </td>
                           </tr>
                           @endforeach
