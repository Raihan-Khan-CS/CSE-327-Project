                ...
                <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
                    <tr>
                        <td valign="top">
                          ...
                          <h2 style="color: green; font-size: 26px;"><strong>OSUD LAGBE Online</strong></h2>
                        </td>
                        <td align="right">
                            <pre class="font" >
                               OSUD LAGBE Head Office
                               Email:osudlagbe@gmail.com <br>
                               Mob: 01738 950 996 <br>
                               SAC 310, NSU <br>
                        ...
                        <td>
                          <p class="font" style="margin-left: 20px;">
                           ...
                           <strong>Phone:</strong> {{ $order->phone }} <br>
                            @php
                                $division = $order->division->division_name_en;
                                $district = $order->district->district_name_en;
