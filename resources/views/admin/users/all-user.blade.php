                        ...
                        <div class="table-responsive">
                                ...
                                <div class="col-sm-12 col-md-6">
                                    <div id="user_list_datatable_info" class="dataTables_filter">
                                            <div class="form-group mb-0">
                                                <input type="search" class="form-control" id="userSearch" placeholder="Search" aria-controls="user-list-table">
                                            </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                    <span class="badge pill-badge badge-danger" style=" font-size:14px;">{{ Carbon\Carbon::parse($item->last_seen)->diffForHumans() }}</span>
                                    @endif
                                </td>
                                <td>
                                    @if($item->inban == 0)
