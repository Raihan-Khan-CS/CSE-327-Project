    ...
    <div class="iq-navbar-custom">
       ...
       <div class="navbar-breadcrumb">
          ...
          <nav aria-label="breadcrumb">
             <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('brands') }}">Role</a></li>
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="flex align-items-center list-user-action d-flex">
                                    <a data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="{{ route('role.edit',$row->id) }}"><i class="ri-pencil-line"></i></a>
